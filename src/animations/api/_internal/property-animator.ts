...
export class PropertyAnimator {
  ...
  /**
   * Update element using from/to properties
   */
  private updateFromToProperties(
    propertyManager: PropertyManager,
    fromProps: AnimationProperties,
    toProps: AnimationProperties,
    progress: number
  ): void {
    this.interpolateAndApply(propertyManager, fromProps, toProps, progress);
  }
