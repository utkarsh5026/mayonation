...
describe("StaggerManager", () => {
  ...
  describe("calculateElementProgress", () => {
    ...
    describe("First element (index 0)", () => {
      it("should be inactive before start time", () => {
        const result = manager.getElementProgressAtTime(0, -50, 500);
      ...
      it("should be active during animation", () => {
        const result = manager.getElementProgressAtTime(0, 250, 500);
        expect(result).toEqual({
      ...
      it("should be complete after end time", () => {
        const result = manager.getElementProgressAtTime(0, 600, 500);
        expect(result).toEqual({
          progress: 1,
          isActive: false,
          isComplete: true,
    ...
    describe("Second element (index 1)", () => {
      it("should be inactive before start time", () => {
        const result = manager.getElementProgressAtTime(1, 50, 500);
        expect(result).toEqual({
          progress: 0,
          isActive: false,
          isComplete: false,
      ...
      it("should be active during animation", () => {
        const result = manager.getElementProgressAtTime(1, 350, 500);
      ...
      it("should be complete after end time", () => {
        const result = manager.getElementProgressAtTime(1, 700, 500);
        expect(result).toEqual({
          progress: 1,
          isActive: false,
          isComplete: true,
    ...
    describe("Third element (index 2)", () => {
      it("should be inactive before start time", () => {
        const result = manager.getElementProgressAtTime(2, 150, 500);
        expect(result).toEqual({
          progress: 0,
          isActive: false,
          isComplete: false,
      ...
      it("should be active during animation", () => {
        const result = manager.getElementProgressAtTime(2, 450, 500);
      ...
      it("should be complete after end time", () => {
        const result = manager.getElementProgressAtTime(2, 800, 500);
        expect(result).toEqual({
          progress: 1,
          isActive: false,
          isComplete: true,
    ...
    describe("Edge cases", () => {
      it("should handle exact start time", () => {
        const result = manager.getElementProgressAtTime(1, 100, 500);
        expect(result).toEqual({
          progress: 0,
          isActive: true,
          isComplete: false,
      ...
      it("should handle exact end time", () => {
        const result = manager.getElementProgressAtTime(1, 600, 500);
        expect(result).toEqual({
          progress: 1,
          isActive: true,
          isComplete: false,
  ...
  describe("Complex scenarios", () => {
    it("should handle fast stagger with long duration", () => {
      ...
      for (let i = 0; i < 5; i++) {
        const result = manager.getElementProgressAtTime(i, 500, 1000);
    ...
    it("should handle slow stagger with short duration", () => {
      ...
      const first = manager.getElementProgressAtTime(0, 600, 200);
      const second = manager.getElementProgressAtTime(1, 600, 200);
      const third = manager.getElementProgressAtTime(2, 600, 200);
    ...
    it("should handle zero duration", () => {
      ...
      const result = manager.getElementProgressAtTime(1, 101, 0);
      expect(result).toEqual({
        progress: 1,
        isActive: false,
        isComplete: true,
  ...
  describe("Performance considerations", () => {
    it("should handle large number of elements efficiently", () => {
      ...
      // Test last element
      const result = manager.getElementProgressAtTime(999, 1050, 100);
    ...
    it("should handle fractional stagger delays", () => {
      ...
      const result = manager.getElementProgressAtTime(2, 100, 500);
  ...
  describe("State transitions", () => {
    it("should transition through all states correctly", () => {
      ...
      let result = manager.getElementProgressAtTime(1, 50, 300);
      expect(result.isActive).toBe(false);
      expect(result.isComplete).toBe(false);

      result = manager.getElementProgressAtTime(1, 250, 300);
      expect(result.isActive).toBe(true);
      expect(result.isComplete).toBe(false);

      result = manager.getElementProgressAtTime(1, 450, 300);
      expect(result.isActive).toBe(false);
    ...
    it("should maintain consistent state across multiple calls", () => {
      ...
      const result1 = manager.getElementProgressAtTime(1, 150, 200);
      const result2 = manager.getElementProgressAtTime(1, 150, 200);
